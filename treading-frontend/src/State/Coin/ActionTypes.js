...
export const FETCH_COIN_LIST_SUCCESS = "FETCH_COIN_LIST_SECCESS";
...
export const FETCH_TOP_50_COINS_SUCCESS = "FETCH_TOP_50_COINS_SECCESS";
...
export const FETCH_MARKET_CHART_SUCCESS = "FETCH_MARKET_CHART_SECCESS";
...
export const FETCH_COIN_BY_ID_SUCCESS = "FETCH_COIN_BY_ID_SECCESS";
...
export const FETCH_COIN_DETAILS_SUCCESS = "FETCH_COIN_DETAILS_SECCESS";
export const FETCH_COIN_DETAILS_FAILURE = "FETCH_COIN_DETAILS_FAILURE";

export const SEARCH_COIN_REQUEST = "SEARCH_COIN_REQUEST";
export const SEARCH_COIN_SUCCESS = "SEARCH_COIN_SECCESS";
